...
class ChatVaultService(val serviceHub: AppServiceHub) : SingletonSerializeAsToken() {
    ...
    fun getChatMessagesBy(chatId: UniqueIdentifier, chatQuerySpec: ChatQuerySpec): List<StateAndRef<ChatInfo>> {
        // @todo: to implement
        return emptyList()
    }
    ...
    fun getAllChatsBy(chatQuerySpec: ChatQuerySpec): List<StateAndRef<ChatInfo>> {
        // @todo: to implement
        return emptyList()
    }
